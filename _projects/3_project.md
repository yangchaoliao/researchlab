...
We pursue physics-based, microstructure-resolved modeling of glass–ceramics (GCs) to connect processing, crystallization, and performance. Our goal is to build predictive tools that reveal how nucleation, crystal growth, and resulting microstructures govern key functional properties, enabling rational design beyond empirical trial-and-error.
...
<div class="caption">
    Microstructure-guided glass ceramics design via physics transfer (https://doi.org/10.1103/lcrf-hxh4)
</div>
